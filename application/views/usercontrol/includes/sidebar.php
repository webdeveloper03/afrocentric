...
.reload-btn{
 ...
 <!-- ========== Left Sidebar Start ========== -->
			...
			<ul>
			    ...
			    <li class="d-none"><a href="<?php echo base_url();?>usercontrol/store_markettools/"><i class="mdi mdi-archive"></i><?= __('user.my_links') ?></a></li>
                ...
                <li class="has_sub d-none">
		     	...
		     	<li class = "d-none"><a href="<?php echo base_url();?>usercontrol/store_logs/"><i class="mdi mdi-trending-up"></i><?= __('user.my_all_logs') ?></a></li>


		     	<li class="d-none"><a href="<?php echo base_url('/usercontrol/my_network'); ?>" class="waves-effect"><i class="mdi mdi-view-dashboard"></i><span> <?= __('user.page_title_my_network') ?></span></a></li>
		     	<li class="d-none"><a href="<?php echo base_url('/ReportController/user_reports'); ?>" class="waves-effect"><i class="mdi mdi-account-settings-variant"></i><span> <?= __('user.my_page_title_user_reports') ?></span></a></li>
				<li class="d-none"><a href="<?php echo base_url('usercontrol/contact-us');?>"><i class="mdi mdi-store"></i> <span>Contact Admin</span></a></li>
