                                	...
                                	<div class="login-reg-form">
            	                        <div class="tab-content">
            	                            <div class="tab-pane fade show active mt-5" role="tabpanel" id="login">
            	                                ...
            	                                <a href="#register" class="toggle-sign-up btn btn-light btn-block mt-2"><?= __('user.sign_up') ?></a>
            	                            </div>
            
            	                            <div class="tab-pane fade" role="tabpanel" id="register">
            	                                <h1 class="card-title"><?= __('user.sign_up') ?></h1>
            	                                <p class="subtitle"><?= __('user.enter_your_information_to_setup_a_new_account') ?></p>
            	                                <?= $register_fomm ?>
            	                                <a href="#login" class="toggle-sign-in btn btn-light btn-block mt-2"><?= __('user.back_to_login') ?></a>
            	                               </div>
            	                        </div>
            	                    </div>
