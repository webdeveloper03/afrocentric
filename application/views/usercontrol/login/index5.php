                            	...
                            	<div class="login-reg-form">
        	                        <div class="tab-content">
        	                            <div class="tab-pane fade show active" role="tabpanel" id="login">
        	                                ...
        	                                <h1 class="card-title"><?= __('user.login') ?></h1>
        	                                ...
        	                                <p class="mb-0 subtitle d-block text-center mt-3"><?= __('user.dont_have_an_account_yet?') ?><a href="#register" class="toggle-sign-up"><?= __('user.sign_up') ?></a></p>
        	                            </div>
        
        	                            <div class="tab-pane fade" role="tabpanel" id="register">
        	                                <h1 class="card-title"><?= __('user.register') ?></h1>
        	                                <p class="subtitle"><?= __('user.enter_your_information_to_setup_a_new_account') ?></p>
        	                                <?= $register_fomm ?>
        	                                <p class="mb-0 subtitle d-block text-center mt-3"><?= __('user.already_have_an_account') ?> <a href="#login" class="toggle-sign-in"><?= __('user.login') ?></a></p>
        	                            </div>
        	                        </div>
        	                    </div>
