	...
	<div class="card-body">
		<div class="row">
			...
			<div class="col-sm-12 col-md-8 col-lg-6 text-center">
				<a href="<?= base_url('admin/blog/create') ?>" class="btn btn-warning c-btn-custom">
...
<script type="text/javascript">
	function getPage(page,t) {
		...
		$.ajax({
			url:'<?= base_url("admin/blog/index") ?>/' + page,
			type:'POST',
			dataType:'json',
			data:data,
			beforeSend:function(){
	...
	function getDetailPage(id){
		window.location.href=`<?= base_url('admin/blog/details') ?>/${id}`;
	}
</script>