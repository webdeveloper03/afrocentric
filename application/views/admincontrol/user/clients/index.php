            ...
            <div class="col-12">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-md-4 col-lg-2">
                                <select class="form-control1 dropdown-toggle nb-form-control" name="country_id" id="country_id">
                ...
                <div class="m-b-10">
                    <?php foreach( range('A', 'Z') as $elements) { ?> 
                        <span class="m-1 mr-2"><?= $elements ?> </span>
                    <?php }  ?>
                </div>
                        ...
                        <div class="table-rep-plugin">
                            ...
                            <div class="table-responsive b-0" data-pattern="priority-columns">
                                <table id="tech-companies-1" class="table  table-striped">
                                    ...
                                    <tbody>
                                        <?php foreach($userslist as $clients){ ?>
                                            <tr>
