...
<div class="row">
    <div class="col-12">
        <?php 
        $returnUrl = base_url('admin/user/designers');
        if ($record == null) {?>
            <div class="card m-b-30">
                <div class="card-body"> 
                    <div class="text-center">
                        ...
                        <h3 class="m-t-40 text-center text-muted"><?= __('admin.no') ?> <?= __('admin.designers') ?></h3>
                    </div>
                </div>
            </div>
        <?php } else { 
                            ...
                            <div class="profile-info-sec pt-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 mt-3">
                                        <span class="btn btn-light btn-sm mr-1">Unisex</span>
                                        <span class="btn btn-light btn-sm mr-1">Children</span>
                                        <span class="btn btn-light btn-sm mr-1">Bridal</span>
                                        <span class="btn btn-light btn-sm mr-1">Traditional</span>
                                        <span class="btn btn-light btn-sm mr-1">Corporate</span>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                ...
                                <div class="row m-t-30 m-b-30">
                                    <div class="col-sm-12">
                                        <?php if($record->status==0) { ?>
                                            <a href="javascript:void(0)" class="btn btn-success btn-custom" data-toggle="modal" data-target="#acceptProfileModal">
                                        ...
                                        <?php } else if($record->status==2) { ?>
                                            <a href="javascript:void(0)" class="btn btn-success btn-custom ml-4" data-toggle="modal" data-target="#unblockModal">
                                                ...
                                                <?= __('admin.unblock') ?> <?= __('admin.designer') ?>
                                            </a>
                        ...
                        <div class="row mt-4">
                            <div class="col-sm-12">
                                <ul class="c-nav nav nav-pills justify-content-center" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link active show" data-toggle="tab" href="#products_listing" role="tab">
                                            <?= __('admin.products') ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" data-toggle="tab" href="#catalog_listing" role="tab">
                                            <?= __('admin.catalog') ?></a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div class="col-sm-12">
                                <div class="tab-content">
                                    <div class="tab-pane p-3 active show" id="products_listing" role="tabpanel">
                                        <div class="row">
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action=""  enctype="multipart/form-data" id="blockUserForm">
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-3 col-sm-8">                  
                                <h5 class="text-center"><?= __('admin.block') ?> <?= __('admin.designer') ?></h5>
                                <p class="text-center"><?= __('admin.block_designer_title') ?></p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-2 col-sm-9">
                                <div class="form-group">
                                    <div class="form-control custom-form-control">
                                        <label class="control-label"><?= __('admin.why_do_you_want_to_block_the_designer') ?></label>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action=""  enctype="multipart/form-data" id="unblockUserForm">
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-3 col-sm-8">                  
                                <h5 class="text-center"><?= __('admin.unblock') ?> <?= __('admin.designer') ?></h5>
                                <p class="text-center"><?= __('admin.unblock_designer_title') ?></p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-2 col-sm-9">
                                <div class="form-group">
                                    <div class="form-control custom-form-control">
                                        <label class="control-label"><?= __('admin.why_do_you_want_to_unblock_the_designer') ?></label>
                                        <input type="text" name="status_reason" class="form-control" placeholder="<?= __('admin.reason') ?>">
                                    </div>
                                </div>                        
                            </div>
...
<?php } else { ?>
    <div class="modal fade" id="acceptProfileModal" data-backdrop="static" tabindex="-1" role="dialog" aria-hidden="true">
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action=""  enctype="multipart/form-data" id="acceptUserForm">
                        <div class="row justify-content-center mb-5">
                            <div class="col-sm-offset-3 col-sm-8">                  
                                <h5 class="text-center"><?= __('admin.accept') ?> <?= __('admin.designers_application') ?></h5>
                                <p class="text-center"><?= __('admin.accept_designers_application_title') ?></p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-2 col-sm-9 c-font-weight-bold">
                    ...
                    <form class="form-horizontal" method="post" action=""  enctype="multipart/form-data" id="rejectUserForm">
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-3 col-sm-8">                  
                                ...
                                <p class="text-center"><?= __('admin.reject_application_designer_title') ?></p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-2 col-sm-9">
                                <div class="form-group">
                                    <div class="form-control custom-form-control">
                                        <label class="control-label"><?= __('admin.why_do_you_want_to_reject_the_designers_application') ?></label>
                                        <input type="text" name="status_reason" class="form-control" placeholder="<?= __('admin.reason') ?>">
                                    </div>
                                </div>                        
                            </div>
