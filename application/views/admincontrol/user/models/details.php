...
<div class="row">
    <div class="col-12">
        <?php 
        $returnUrl = base_url('admin/user/models');
        if ($record == null) {?>
            <div class="card m-b-30">
                <div class="card-body"> 
                    <div class="text-center">
                        ...
                        <h3 class="m-t-40 text-center text-muted"><?= __('admin.no') ?> <?= __('admin.models') ?></h3>
                    </div>
                </div>
            </div>
        <?php } else { 
                                    ...
                                    <div class="col-sm-12">
                                        ...
                                        <?php } else if($record->status==2) { ?>
                                            <a href="javascript:void(0)" class="btn btn-success btn-custom ml-4" data-toggle="modal" data-target="#unblockModal">
                                                ...
                                                <?= __('admin.unblock') ?> <?= __('admin.model') ?>
                                            </a>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action=""  enctype="multipart/form-data" id="blockUserForm">
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-3 col-sm-8">                  
                                <h5 class="text-center"><?= __('admin.block') ?> <?= __('admin.model') ?></h5>
                                <p class="text-center"><?= __('admin.block_model_title') ?></p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-2 col-sm-9">
                                <div class="form-group">
                                    <div class="form-control custom-form-control">
                                        <label class="control-label"><?= __('admin.why_do_you_want_to_block_the_model') ?></label>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    <form class="form-horizontal" method="post" action=""  enctype="multipart/form-data" id="unblockUserForm">
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-3 col-sm-8">                  
                                <h5 class="text-center"><?= __('admin.unblock') ?> <?= __('admin.model') ?></h5>
                                <p class="text-center"><?= __('admin.unblock_model_title') ?></p>
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm-offset-2 col-sm-9">
                                <div class="form-group">
                                    <div class="form-control custom-form-control">
                                        <label class="control-label"><?= __('admin.why_do_you_want_to_unblock_the_model') ?></label>
                                        <input type="text" name="status_reason" class="form-control" placeholder="<?= __('admin.reason') ?>">
                                    </div>
                                </div>                        
                            </div>
