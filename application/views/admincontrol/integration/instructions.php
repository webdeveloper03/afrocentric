				...
				<div class="integration-modules-ins">
					...
					<?php if($module_key == 'affiliate_register_api'){ ?>
						<div id="affiliate_register_api">
							...
							<p class="text-info">Download Postman Example <a target="_blank" href="<?= base_url('assets/Affiliate-Pro.postman_collection.json') ?>">Affiliate-Pro.postman_collection.json</a>. How to import postman data file <a href="https://learning.postman.com/docs/running-collections/working-with-data-files/" target="_target" ><i class="fa fa-external-link"></i></a></p>
