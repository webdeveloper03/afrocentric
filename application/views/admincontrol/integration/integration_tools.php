						...
						<table id="myTable" class="table table-striped">
							<thead>
								<tr>
									...
									<th width="200px"><?php echo __('admin.vendor') ?></th>
...
<script type="text/javascript">
	...
	$(".category_id,.vendor_id, .show_only").on("change",function(){
	...
	/*function myFunction() {
	  ...
	  input = document.getElementById("txt_name2");
