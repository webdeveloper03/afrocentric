<div class="form-group">
	...
	<label class="form-control-label">Enter Your Stripe Email Address</label>

	<input class="form-control" name="stripe_email" >
...
<script type="text/javascript">
	...
	$("#payment-form-stripe").submit(function(){

		$this = $(this);

		$.ajax({

			url:'<?= base_url('payment/call_payment_function/stripe_payment/saveUserSubmit') ?>',

			type:'POST',

			dataType:'json',

			data:$("#payment-form-stripe").serialize(),
