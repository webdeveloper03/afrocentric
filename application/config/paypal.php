 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'SANDBOX_GOES_HERE' : 'PRODUCTION_GOGES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'SANDBOX_GOES_HERE' : 'PRODUCTION_GOGES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'SANDBOX_GOES_HERE' : 'PRODUCTION_GOGES_HERE';
 ...
 */
$config['DeveloperEmailAccount'] = 'DEVELOPEREMAILACCOUNT';
