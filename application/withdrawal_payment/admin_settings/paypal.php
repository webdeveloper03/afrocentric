...
<div class="form-group">
	...
	<label class="form-control-label d-block">ClientID
		...
		<small class="pull-right">
			...
			<a href="https://www.appinvoice.com/en/s/documentation/how-to-get-paypal-client-id-and-secret-key-22" target="_blank">Obtain Client ID and Client Secret from PayPal</a>
